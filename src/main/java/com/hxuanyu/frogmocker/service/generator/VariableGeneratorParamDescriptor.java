...
public class VariableGeneratorParamDescriptor extends ParamDescriptor {
    ...
    public VariableGeneratorParamDescriptor(String name, String label, String description,
                                            com.hxuanyu.frogmocker.service.common.ParamType paramType, boolean required,
                                            String defaultValue, List<com.hxuanyu.frogmocker.service.common.SelectOption> options) {
    ...
    public static VariableGeneratorParamDescriptor text(String name, String label,
        ...
        param.setParamType(com.hxuanyu.frogmocker.service.common.ParamType.TEXT);
    ...
    public static VariableGeneratorParamDescriptor bool(String name, String label,
        ...
        param.setLabel(label);
        param.setDescription(description);
        param.setParamType(com.hxuanyu.frogmocker.service.common.ParamType.BOOLEAN);
    ...
    public static VariableGeneratorParamDescriptor select(String name, String label,
                                                          String description, boolean required,
                                                          String defaultValue, com.hxuanyu.frogmocker.service.common.SelectOption... options) {
        VariableGeneratorParamDescriptor param = new VariableGeneratorParamDescriptor();
        param.setName(name);
        param.setLabel(label);
        param.setDescription(description);
        param.setParamType(com.hxuanyu.frogmocker.service.common.ParamType.SELECT);
        param.setRequired(required);
        param.setDefaultValue(defaultValue);
