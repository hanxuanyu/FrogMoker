        ...
        return new VariableGeneratorDescriptor(
                ...
                Arrays.asList(
                        ...
                        VariableGeneratorParamDescriptor.select("charset", "字符集", "选择生成字符串所使用的字符集", false, "alphanumeric",
                                new com.hxuanyu.frogmocker.service.common.SelectOption("alpha", "纯字母"),
                                new com.hxuanyu.frogmocker.service.common.SelectOption("numeric", "纯数字"),
                                new com.hxuanyu.frogmocker.service.common.SelectOption("alphanumeric", "字母+数字")
                        ),
