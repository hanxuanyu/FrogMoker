package com.hxuanyu.frogmoker.service.server.impl;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.hxuanyu.frogmoker.entity.RequestLog;
import com.hxuanyu.frogmoker.mapper.MatchRuleMapper;
import com.hxuanyu.frogmoker.mapper.RequestLogMapper;
import com.hxuanyu.frogmoker.service.common.ParamDescriptor;
import com.hxuanyu.frogmoker.service.common.ParamDescriptorBuilder;
import com.hxuanyu.frogmoker.service.server.*;
    ...
    private class HttpMockHandler extends AbstractHandler {
        ...
        public void handle(String target, Request baseRequest, HttpServletRequest request,
            ...
            try {
                ...
                // 查找匹配规则
                List<com.hxuanyu.frogmoker.service.server.MatchRule> rules = loadMatchRules(instanceId);
                com.hxuanyu.frogmoker.service.server.MatchRule matchedRule = requestMatcher.findMatchingRule(serverRequest, rules);
        ...
        private List<com.hxuanyu.frogmoker.service.server.MatchRule> loadMatchRules(Long instanceId) {
            try {
                List<com.hxuanyu.frogmoker.entity.MatchRule> entities = matchRuleMapper.selectList(
                        new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.hxuanyu.frogmoker.entity.MatchRule>()
                                .eq(com.hxuanyu.frogmoker.entity.MatchRule::getInstanceId, instanceId)
                                .eq(com.hxuanyu.frogmoker.entity.MatchRule::getEnabled, true)
                                .orderByDesc(com.hxuanyu.frogmoker.entity.MatchRule::getPriority)
                );
